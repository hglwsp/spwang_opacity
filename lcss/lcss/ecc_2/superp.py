...
FINE_TUNE_U = 0   # set to 1 for fine-tuning a pre-trained model
FINE_TUNE_B = 0
FIX_CTRL = 1
FIX_BARR = 0
...
############################################
N_H_B = 2 # the number of hidden layers for the barrier
D_H_B = 16
...
# Init
############################################
DATA_EXP_I = np.array([8,8])
DATA_LEN_I = np.power(2, DATA_EXP_I)
BLOCK_EXP_I = np.array([6,6])
