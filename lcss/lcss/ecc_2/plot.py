...
def plot_sys_2d(barr_nn, ctrl_nn):
    ...
    def plot_init(init_range, init_shape):
        ...
        if init_shape == 3: # triangle
            init = matplotlib.patches.Polygon(((init_range[0][0] ,  init_range[1][0]) , (init_range[0][1] ,  init_range[1][0]),
                                               (init_range[0][1] ,  init_range[1][1]),(init_range[0][0] ,  init_range[1][0])) ,facecolor='green')
        return init
    ...
    def plot_unsafe(unsafe_range, unsafe_shape):
        ...
        elif unsafe_shape == 3:  # triangle
            unsafe = matplotlib.patches.Polygon(
                ((unsafe_range[0][0], unsafe_range[1][0]), (unsafe_range[0][1], unsafe_range[1][0]),
                 (unsafe_range[0][1], unsafe_range[1][1]), (unsafe_range[0][0], unsafe_range[1][0])), facecolor='red')
        elif unsafe_shape == 4:  # triangle
            unsafe = matplotlib.patches.Polygon(
                ((unsafe_range[0][0], unsafe_range[1][0]), (unsafe_range[0][1], unsafe_range[1][1]),
                 (unsafe_range[0][0], unsafe_range[1][1]), (unsafe_range[0][0], unsafe_range[1][0])), facecolor='red')
        else: # a parabola?
...
def plot_sys(barr_nn, ctrl_nn):
    ...
    # elif superp.DIM_S == 4:
    #     plot4d.plot_sys_4d(barr_nn, ctrl_nn)
    else:
