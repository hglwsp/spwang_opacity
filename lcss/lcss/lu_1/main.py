...
batches_init, batches_unsafe, batches_domain,batches_goal = data.gen_batch_data()
...
BATCHES_G = len(batches_goal)
BATCHES = max(BATCHES_I, BATCHES_U,BATCHES_D,BATCHES_G)
NUM_BATCHES = [BATCHES_I, BATCHES_U,BATCHES_D , BATCHES_G,BATCHES]

# train and return the learned model
time_start_train = time.time()
res = train.itr_train(barr_nn, ctrl_nn, batches_init, batches_unsafe,batches_domain,batches_goal, NUM_BATCHES)
