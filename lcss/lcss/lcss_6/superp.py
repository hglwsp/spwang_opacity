...
DIM_C = 5 # dimension of controller input
...
BARR_ACT = nn.ReLU()
# BARR_ACT = nn.LeakyReLU(negative_slope=0.01, inplace=False)
# CTRL_ACT = acti.my_act()
# CTRL_ACT = nn.LeakyReLU(negative_slope=0.01, inplace=False)
CTRL_ACT = nn.ReLU()
#CTRL_ACT = nn.Sigmoid()
