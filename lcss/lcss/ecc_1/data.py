...
def gen_batch_data():
    ...
    # batch_init.append(torch.tensor([[0.0,0.0,0.0,0.0]
    # ]))
    batch_unsafe = batch_data(full_unsafe, superp.DATA_LEN_U, superp.BLOCK_LEN_U, prob.cons_unsafe)
    # batch_unsafe_1 = batch_data(full_unsafe_1, superp.DATA_LEN_U, superp.BLOCK_LEN_U, prob.cons_unsafe_1)
    # batch_unsafe.append(torch.tensor([[0.0, 1.0001, 0.1, 0.0]]))
    ...
    # batch_domain_1 = batch_data(full_domain_1, superp.DATA_LEN_D, superp.BLOCK_LEN_D, prob.cons_domain)
    # batch_domain.append(torch.tensor([[1.1082814753159176, 0.047128444800545746, 0.1, 0.0]]))
