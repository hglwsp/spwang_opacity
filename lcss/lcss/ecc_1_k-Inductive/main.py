...
res = train.itr_train(barr_nn, ctrl_nn,ctrl_nn2, batches_init, batches_unsafe, batches_domain, NUM_BATCHES)
...
if res == True:
    ...
    torch.save(ctrl_nn.state_dict(), 'pre_trained_ctrl2.pt')
