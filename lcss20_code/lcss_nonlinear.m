...
syms x1 x2 v1 v2 u1 u2;
vars = [x1; x2; v1; v2; u1;u2];
...
[prog,L_conu] = sospolyvar(prog,Mon_u2,'wscoeff');  
[prog,L_conu1] = sospolyvar(prog,Mon_u2,'wscoeff');  
[prog,L_conu2] = sospolyvar(prog,Mon_u2,'wscoeff');
...
f_x1 = x1 + v1;
f_v1 = v1 + M*g*l*1/J*sin(x1) - 1/tol*v1 + km/tol*u1 
...
f_x2 = x2 + v2;
f_v2 = v2 + M*g*l*1/J*sin(x2) - 1/tol*v2 + km/tol*u2;
% f_x2 = x2 + v2*v2 - v2 + u2;
% f_v2 = 2*v2 + u2;
